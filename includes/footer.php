<?php
    ...
    Data: 11/05/2020
    Descrição: Arquivo de rodapé padrão.
    */
?>
            ...
            <div class="row">
                ...
                <div class="col-1 col-md">
                    ...
                    <ul class="list-unstyled text-small">
                        <li><a class="text-muted" href="https://github.com/jmicheld">GitHub</a></li>
                        <li><a class="text-muted" href="https://www.linkedin.com/in/jean-michel-deschamps-2966a356/">LinkeIn</a></li>
                    </ul>
                </div>
            </div>
        </footer>
